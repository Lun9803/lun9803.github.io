  	...
  	return (
		<div className={classes.timeSection}>
			...
			<div className={classes.addEventButton}>
				{/* <IconButton style={{marginRight:12}}><FavoriteIcon style={{width:50,height:50, color:white}}/></IconButton> */}
				<IconButton onClick={()=>{setSelectedEvent();setModalOpen(true)}}><AddButton style={{width:50,height:50, color:onetimeEventsColour}}/></IconButton>
				{/* <IconButton style={{marginLeft:12}}><CalenderIcon style={{width:50,height:50, color:white}}/></IconButton> */}
			</div>
